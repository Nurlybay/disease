...
как достоверный материал для диагностики. После получения MP4 их нужно отдельно
подключить к соответствующим случаям — имена файлов выше являются планом,
а не уже подключёнными видео.
