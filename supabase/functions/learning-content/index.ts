...
Deno.serve(async req => {
 ...
 if(asset!==DEMO){
  ...
  try{
   ...
   if((section==='teacher'||asset==='teacher.js'||asset==='teacher-wizard.js'||asset==='constructor.js'||asset==='media-studio.js')&&!['teacher','admin'].includes(user.app_metadata?.role))return reply(403,{error:'teacher_required'});
