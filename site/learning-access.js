...
function remote(src){return /^characters\/(?!manifest\.js|loader\.js)[^/]+\.js$/.test(src)||['teacher.js','constructor.js','clinical-media.js','media-lab.js'].includes(src);}
...
window.LearningAccess={loadScript,isDemo:()=>demo&&!signed};
